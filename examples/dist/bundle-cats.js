...
(function($PS) {
  ...
  var update = function (v) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Action.setState(function (v1) {
          ...
          return Control_Bind.bind(Run.bindRun)(Pha_Example_Effects_Http.ajax("https://api.giphy.com/v1/gifs/random?api_key=dc6zaTOxFJmzC&tag=cat"))(function (v1) {
              var status = Data_Maybe.maybe(Failure.value)(Success.create)(Control_Bind.bind(Data_Maybe.bindMaybe)(v1)(function (v2) {
                  return Data_Either.hush(Control_Monad_Except.runExcept(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Foreign_Index.ix(Foreign_Index.indexableExceptT)(Foreign_Index.indexString)(Foreign_Index.ix(Foreign_Index.indexableForeign)(Foreign_Index.indexString)(v2)("data"))("image_url"))(Foreign.readString)));
              }));
