  ...
  var on_ = function (n) {
      return function (handler) {
          return $foreign.unsafeOnWithEffect(n)(function (ev) {
              return Control_Applicative.pure(Effect.applicativeEffect)(handler(ev));
          });
      };
  };
  exports["on_"] = on_;
      ...
      return function (setS) {
          return function (update) {
              return function (interpreter) {
                  ...
                  var dispatch = function ($7) {
                      return runAction(update($7));
                  };
                  var dispatchEvent = function (ev) {
                      return function (handler) {
                          return function __do() {
                              ...
                              throw new Error("Failed pattern match at Pha.App.Internal (line 44, column 13 - line 46, column 36): " + [ msg.constructor.name ]);
                          };
                      };
                  };
                  return {
...
})(PS["Pha.Example.Effects.Http"] = PS["Pha.Example.Effects.Http"] || {});
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Pha.Example.Effects.Http"] = $PS["Pha.Example.Effects.Http"] || {};
  var exports = $PS["Pha.Example.Effects.Http"];
  var $foreign = $PS["Pha.Example.Effects.Http"];
  var Control_Category = $PS["Control.Category"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Symbol = $PS["Data.Symbol"];
  ...
  var interpretHttp = function (v) {
      return $foreign.ajaxAux(Data_Maybe.Just.create)(Data_Maybe.Nothing.value)(v.value0)(v.value1);
  };
...
(function($PS) {
  ...
  var Pha_Example_Effects_Http = $PS["Pha.Example.Effects.Http"];
  var Pha_Update = $PS["Pha.Update"];
  var Run = $PS["Run"];                
  ...
  var viewGif = function (v) {
      ...
      throw new Error("Failed pattern match at Example.Cats (line 48, column 1 - line 48, column 27): " + [ v.constructor.name ]);
  };
  ...
  var update = function (v) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Update.put(Loading.value))(function () {
          return Control_Bind.bind(Run.bindRun)(Pha_Example_Effects_Http.ajax("https://api.giphy.com/v1/gifs/random?api_key=dc6zaTOxFJmzC&tag=cat"))(function (res) {
              var status = Data_Maybe.maybe(Failure.value)(Success.create)(Control_Bind.bind(Data_Maybe.bindMaybe)(res)(function (json) {
                  return Data_Either.hush(Control_Monad_Except.runExcept(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Foreign_Index.ix(Foreign_Index.indexableExceptT)(Foreign_Index.indexString)(Foreign_Index.ix(Foreign_Index.indexableForeign)(Foreign_Index.indexString)(json)("data"))("image_url"))(Foreign.readString)));
              }));
              return Pha_Update.put(status);
          });
      });
  };
  ...
  var main = Pha_App.attachTo("root")(Pha_App.app({
      ...
      interpreter: Data_Functor_Variant.match()()()({
          http: Pha_Example_Effects_Http.interpretHttp
      })
  }));
