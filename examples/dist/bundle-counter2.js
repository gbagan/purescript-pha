...
(function($PS) {
  ...
  var interpretDelay = function (ms) {
      return function (msg) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(Data_Time_Duration.Milliseconds(Data_Int.toNumber(ms))))(function () {
  ...
  var delay = function (ms) {
      return function (next) {
          return Data_Functor_Variant.inj()(new Data_Symbol.IsSymbol(function () {
              return "delay";
          }))(functorDelay)(_delay)(new Delay(ms, next));
      };
  };
...
(function($PS) {
  ...
  var update = function (v) {
      return function (v1) {
          ...
          if (v1 instanceof DelayedIncrement) {
              return {
                  model: model,
                  effects: [ new Delay(100, Increment.value) ]
              };
          };
          throw new Error("Failed pattern match at Example.Counter2 (line 30, column 1 - line 30, column 49): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  ...
  var interpreter = function (v) {
      return Pha_Effects_Delay.interpretDelay(v.value0)(v.value1);
  };
  var main = Pha_App.attachTo("root")(Pha_App.app({
      init: Pha.purely(model),
      view: view,
      update: update,
