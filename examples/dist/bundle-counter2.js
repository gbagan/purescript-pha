...
(function($PS) {
  ...
  var onClick = function (handler) {
      return on("click")(function (ev) {
          return Control_Applicative.pure(Effect.applicativeEffect)(Data_Functor.map(Data_Maybe.functorMaybe)(handler)(Web_UIEvent_MouseEvent.fromEvent(ev)));
      });
  };
