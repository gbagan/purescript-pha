...
(function($PS) {
  ...
  var interpret = function (v) {
      return function (v1) {
          var go = function (v2) {
              ...
              throw new Error("Failed pattern match at Pha.App (line 103, column 5 - line 107, column 15): " + [ v2.constructor.name ]);
          };
  ...
  var app$prime = function (v) {
                      ...
                      return function (vdom) {
                          ...
                          var render = function (newVDom) {
                              return function __do() {
                                  ...
                                  throw new Error("Failed pattern match at Pha.App (line 56, column 17 - line 62, column 45): " + [ pnode.constructor.name ]);
                              };
                          };
                          var listener = function (e) {
                              ...
                              throw new Error("Failed pattern match at Pha.App (line 95, column 13 - line 99, column 39): " + [ v2.constructor.name ]);
                          };
                          var dispatchEvent = function (ev) {
                              return function (handler) {
                                  return function __do() {
                                      ...
                                      throw new Error("Failed pattern match at Pha.App (line 89, column 25 - line 91, column 48): " + [ msg.constructor.name ]);
                                  };
                              };
                          };
                          ...
                          return function __do() {
                              ...
                              throw new Error("Failed pattern match at Pha.App (line 46, column 9 - line 48, column 32): " + [ v.init.action.constructor.name ]);
                          };
                      };
                  };
              };
      ...
      return function __do() {
          ...
          throw new Error("Failed pattern match at Pha.App (line 34, column 5 - line 42, column 41): " + [ selected.constructor.name ]);
      };
  };
  var app = function (v) {
      return app$prime({
...
(function($PS) {
  ...
  var $foreign = $PS["Pha.Subscriptions"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Maybe = $PS["Data.Maybe"];
  ...
  var on = function (n) {
      return function (d) {
          ...
          return $foreign.makeSubscription(fn)({
              name: n,
              decoder: d
          });
      };
...
(function($PS) {
  ...
  var main = Pha_App.app({
      ...
      view: view,
      update: update,
      subscriptions: Data_Function["const"]([ Pha_Subscriptions.onKeyDown(keyDownHandler) ]),
      selector: "#root"
  });
  exports["state"] = state;
