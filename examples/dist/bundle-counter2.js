...
(function(exports) {
  ...
  exports.noProp = [-1]
  exports.unsafeOnWithEffect = n => h => [1, n, h]
  exports.h = h;
              ...
              var dispatchEvent = function (ev) {
                  return function (handler) {
                      ...
                      return function __do() {
                          ...
                          throw new Error("Failed pattern match at Pha (line 130, column 13 - line 132, column 37): " + [ v1.msg.constructor.name ]);
                      };
                  };
              };
              return {
  ...
  var on$prime = function (name) {
      var fn = function (dispatch) {
          return function (decoder2) {
              return $foreign.addEventListener(name)(handleEvent(dispatch)(decoder2));
          };
      };
      return function (decoder) {
          return $foreign.makeSub(fn)(decoder);
      };
  };
  var onkeydown = function (f) {
      return on$prime("keydown")((function () {
          var $6 = Data_Functor.map(Control_Monad_Except_Trans.functorExceptT(Data_Identity.functorIdentity))(f);
          return function ($7) {
              return $6(Pha_Events_Decoder.key($7));
          };
      })());
  };
...
(function($PS) {
  ...
  var update = function (v) {
      ...
      throw new Error("Failed pattern match at Example.Counter2 (line 33, column 1 - line 33, column 35): " + [ v.constructor.name ]);
  };
  var main = Pha.app({
