...
(function($PS) {
  ...
  var handleEvent = function (dispatch) {
      return function (decoder) {
          return function (ev) {
              var v = Debug_Trace.spy()("msg")(Control_Monad_Except.runExcept(decoder(Foreign.unsafeToForeign(ev))));
              if (v instanceof Data_Either.Right && v.value0 instanceof Data_Maybe.Just) {
                  return Debug_Trace.spy()("dispatch")(dispatch(v.value0.value0));
              };
              return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
          };
      };
...
(function($PS) {
  ...
  var update = function (v) {
      ...
      throw new Error("Failed pattern match at Example.Counter2 (line 34, column 1 - line 34, column 35): " + [ v.constructor.name ]);
  };
  var main = Pha.app({
