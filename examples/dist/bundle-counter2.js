...
(function($PS) {
  ...
  var view = function (v) {
      return Pha_Elements.div([  ])([ Pha_Elements.div([ Pha.class_("counter") ])([ Pha.text(Data_Show.show(Data_Show.showInt)(v.counter)) ]), Pha_Elements.button([ Pha_Attributes.onclick(Increment.value) ])([ Pha.text("Increment") ]), Pha_Elements.button([ Pha_Attributes.onclick(DelayedIncrement.value) ])([ Pha.text("Delayed Increment") ]), Pha_Elements.div([  ])([ Pha_Elements.span([  ])([ Pha.text("green when the counter is even") ]), Pha_Elements.div([ Pha.class_("box"), Pha["class'"]("even")(Data_Int.even(v.counter)) ])([  ]) ]), Pha_Elements.div([  ])([ Pha.text("press space to increment the counter") ]) ]);
  };
  var state = {
      counter: 0
  };
