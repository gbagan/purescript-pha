...
(function($PS) {
  ...
  var on$prime = function (name) {
      var fn = function (dispatch) {
          return function (decoder) {
              return function __do() {
                  var v = Web_Event_EventTarget.eventListener(handleEvent(dispatch)(decoder))();
                  Control_Bind.bind(Effect.bindEffect)(Data_Functor.mapFlipped(Effect.functorEffect)(Web_HTML.window)(Web_HTML_Window.toEventTarget))(Web_Event_EventTarget.addEventListener(name)(v)(false))();
                  return Control_Bind.bind(Effect.bindEffect)(Data_Functor.mapFlipped(Effect.functorEffect)(Web_HTML.window)(Web_HTML_Window.toEventTarget))(Web_Event_EventTarget.removeEventListener(name)(v)(false));
              };
          };
      };
  ...
  var onKeyDown = function (f) {
      return on$prime("keydown")((function () {
          var $9 = Data_Functor.map(Control_Monad_Except_Trans.functorExceptT(Data_Identity.functorIdentity))(f);
          return function ($10) {
              return $9(Pha_Events_Decoder.key($10));
          };
      })());
  };
...
(function($PS) {
  ...
  var increment = Pha_Update.purely(function (v) {
      return {
