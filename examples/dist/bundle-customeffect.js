...
})(PS["Example.CustomEffect"] = PS["Example.CustomEffect"] || {});
(function(exports) {
...
(function($PS) {
  ...
  "use strict";
  $PS["Example.CustomEffect"] = $PS["Example.CustomEffect"] || {};
  var exports = $PS["Example.CustomEffect"];
  var $foreign = $PS["Example.CustomEffect"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Category = $PS["Control.Category"];
  var Data_Functor = $PS["Data.Functor"];
  ...
  var pointerPosition = $foreign.pointerPositionAux(Data_Maybe.Nothing.value)(Data_Maybe.Just.create);
  var interpretPointer = function (v) {
      return Control_Bind.bind(Effect.bindEffect)(pointerPosition(v.value0))(v.value1);
  };
  ...
  var updatePosition = function (ev) {
      return Control_Bind.bind(Run.bindRun)(getPointerPosition(ev))(function (v) {
  ...
  var clearPosition = Pha_Action.setState(function (v) {
      return {
          position: Data_Maybe.Nothing.value
      };
  });
  var view = function (v) {
      return Pha_Elements.div([  ])([ Pha_Elements.div([ Pha.style("width")("400px"), Pha.style("height")("400px"), Pha.style("border")("solid grey thin"), Pha_Attributes["onpointermove'"](updatePosition), Pha_Attributes.onpointerleave(clearPosition) ])([ Pha_Svg.svg([ Pha_Svg.viewBox(0)(0)(100)(100) ])([ Pha.maybeN(Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(v.position)(function (v1) {
          return Pha_Svg.circle([ Pha_Svg.r("7.0"), Pha_Svg.fill("red"), Pha_Svg.stroke("black"), Pha.style("transform")(Pha_Util.translate(Pha_Util.pc(v1.x))(Pha_Util.pc(v1.y))) ]);
      })) ]) ]) ]);
  };
  var main = Pha.app({
      state: state,
  ...
  exports["interpretPointer"] = interpretPointer;
  exports["main"] = main;
  exports["functorPointer"] = functorPointer;
  exports["pointerPositionAux"] = $foreign.pointerPositionAux;
})(PS);
PS["Example.CustomEffect"].main();