...
(function($PS) {
  ...
  var currentTargetChecked = Control_Bind.composeKleisli(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(currentTarget)(Control_Bind.composeKleisli(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Foreign_Index.readProp("checked"))(Foreign.readBoolean));
  var currentTargetValue = Control_Bind.composeKleisli(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(currentTarget)(Control_Bind.composeKleisli(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Foreign_Index.readProp("value"))(Foreign.readString));
  exports["currentTargetValue"] = currentTargetValue;
  exports["currentTargetChecked"] = currentTargetChecked;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.5
  "use strict";
