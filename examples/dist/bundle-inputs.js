...
(function($PS) {
  ...
  var eventEffect = function (v) {
      ...
      throw new Error("Failed pattern match at Pha.Event (line 50, column 1 - line 50, column 51): " + [ v.constructor.name ]);
  };
  exports["targetChecked"] = targetChecked;
  exports["targetValue"] = targetValue;
  exports["eventEffect"] = eventEffect;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.5
  "use strict";
  ...
  var onchange$prime = Pha.Event.create("change");
  ...
  var checked = function (b) {
      return attr(unittoStr)("checked")((function () {
          if (b) {
              return "true";
          };
          return "";
  ...
  var input = function (t) {
      return function (props) {
          return Pha.h("input")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ attr(unittoStr)("type")(t) ])(props))([  ]);
      };
  };
  var value = attr(unittoStr)("value");
  exports["attr"] = attr;
...
(function($PS) {
  ...
  var changeval2 = function (ev) {
      return Control_Bind.bind(Run.bindRun)(Pha_Event.targetValue(ev))(function (v) {
          ...
          throw new Error("Failed pattern match at Example.Inputs (line 41, column 36 - line 43, column 25): " + [ v.constructor.name ]);
      });
  };
  var changeval1 = function (ev) {
      return Control_Bind.bind(Run.bindRun)(Pha_Event.targetValue(ev))(function (v) {
          ...
          throw new Error("Failed pattern match at Example.Inputs (line 36, column 36 - line 38, column 25): " + [ v.constructor.name ]);
      });
  };
