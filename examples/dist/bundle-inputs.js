                  ...
                  var dispatchEvent = function (ev) {
                      return function (handler) {
                          ...
                          return function __do() {
                              ...
                              throw new Error("Failed pattern match at Pha.App (line 84, column 13 - line 86, column 36): " + [ v1.msg.constructor.name ]);
                          };
                      };
                  };
  ...
  var sandbox = function (v) {
      return app({
          ...
          update: function (model) {
              return function (msg) {
                  return purely(v.update(model)(msg));
              };
          },
...
(function($PS) {
  ...
  var update = function (model) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Example.Inputs (line 34, column 1 - line 34, column 29): " + [ model.constructor.name, v.constructor.name ]);
      };
  };
