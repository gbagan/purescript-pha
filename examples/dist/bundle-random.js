...
(function($PS) {
  ...
  var view = function (v) {
      return Pha_Html["div'"]([  ])([ Pha_Html["div'"]([ Pha_Html["class'"]("counter")(true) ])([ Pha.text(Data_Show.show(Data_Show.showInt)(v.dice)) ]), Pha_Html.button([ Pha_Html.click(rollDice) ])([ Pha.text("Roll dice") ]), Pha_Html["div'"]([ Pha_Html["class'"]("puzzle")(true) ])(Data_Array.mapWithIndex(function (i) {
          return function (j) {
      ...
      })(v.puzzle)), Pha_Html.button([ Pha_Html.click(shufflePuzzle) ])([ Pha.text("Shuffle") ]) ]);
  };
  var main = Pha.app({
      state: state,
      view: view,
