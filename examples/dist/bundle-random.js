...
(function($PS) {
  ...
  var viewCard = function (v) {
      ...
      throw new Error("Failed pattern match at Example.Random (line 56, column 1 - line 56, column 25): " + [ v.constructor.name ]);
  };
  var view = function (v) {
      return {
  ...
  var update = function (v) {
      if (v instanceof RollDice) {
          return Control_Bind.bind(Run.bindRun)(Pha_Effects_Random.randomGenerate(Data_Functor.mapFlipped(Control_Monad_Free.freeFunctor)(Pha_Random.randomInt(6))(function (v1) {
              return v1 + 1 | 0;
          })))(function (v1) {
      ...
      if (v instanceof DrawCard) {
          return Control_Bind.bind(Run.bindRun)(Pha_Effects_Random.randomGenerate(Pha_Random.sample([ Ace.value, Two.value, Three.value, Four.value, Five.value, Six.value, Seven.value, Eight.value, Nine.value, Ten.value, Jack.value, Queen.value, King.value ])))(function (v1) {
              ...
              throw new Error("Failed pattern match at Example.Random (line 47, column 5 - line 49, column 28): " + [ v1.constructor.name ]);
          });
      };
      if (v instanceof ShufflePuzzle) {
          return Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v1) {
              return Control_Bind.bind(Run.bindRun)(Pha_Effects_Random.randomGenerate(Pha_Random.shuffle(v1.puzzle)))(function (v2) {
      ...
      throw new Error("Failed pattern match at Example.Random (line 39, column 1 - line 39, column 33): " + [ v.constructor.name ]);
  };
  var state = {
      dice: 1,
