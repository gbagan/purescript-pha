                  ...
                  var dispatchEvent = function (ev) {
                      return function (handler) {
                          ...
                          return function __do() {
                              ...
                              throw new Error("Failed pattern match at Pha.App (line 74, column 13 - line 76, column 36): " + [ v1.msg.constructor.name ]);
                          };
                      };
                  };
...
(function($PS) {
  ...
  var GenWrapper$prime = (function () {
      function GenWrapper$prime(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      GenWrapper$prime.create = function (value0) {
          return function (value1) {
              return new GenWrapper$prime(value0, value1);
          };
      };
      return GenWrapper$prime;
  })();
  var wrapGen = function (rnd) {
      return function (fmsg) {
          return Data_Exists.mkExists(new GenWrapper$prime(rnd, fmsg));
      };
  };                                                                                                                 
  var randomInt = function (n) {
      return Control_Monad_Free.liftF(new RngInt(n, Control_Category.identity(Control_Category.categoryFn)));
  };
  ...
  var functorRng = new Data_Functor.Functor(function (f) {
      return function (m) {
          ...
          throw new Error("Failed pattern match at Pha.Effects.Random (line 16, column 1 - line 16, column 45): " + [ m.constructor.name ]);
      };
  });
  var runRng = (function () {
      var go = function (v) {
          ...
          throw new Error("Failed pattern match at Pha.Effects.Random (line 50, column 5 - line 52, column 44): " + [ v.constructor.name ]);
      };
      return Control_Monad_Free.runFreeM(functorRng)(Control_Monad_Rec_Class.monadRecEffect)(go);
  })();
  var interpretGenerate = function (wrap) {
      return Data_Exists.runExists(function (v) {
          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Data_Functor.mapFlipped(Effect.functorEffect)(runRng(v.value0))(v.value1));
      })(wrap);
  };
  ...
  exports["interpretGenerate"] = interpretGenerate;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.5
  "use strict";
...
(function($PS) {
  ...
  var DiceRolled = (function () {
      function DiceRolled(value0) {
          this.value0 = value0;
      };
      DiceRolled.create = function (value0) {
          return new DiceRolled(value0);
      };
      return DiceRolled;
  })();
  ...
  var CardDrawn = (function () {
      function CardDrawn(value0) {
          this.value0 = value0;
      };
      CardDrawn.create = function (value0) {
          return new CardDrawn(value0);
      };
      return CardDrawn;
  })();
  ...
  var Shuffled = (function () {
      function Shuffled(value0) {
          this.value0 = value0;
      };
      Shuffled.create = function (value0) {
          return new Shuffled(value0);
      };
      return Shuffled;
  })();
  var viewCard = function (v) {
      ...
      throw new Error("Failed pattern match at Example.Random (line 50, column 1 - line 50, column 25): " + [ v.constructor.name ]);
  };
  var view = function (v) {
      return {
  ...
  var interpreter = function (v) {
      return Pha_Effects_Random.interpretGenerate(v.value0);
  };
  var imodel = {
      dice: 1,
  ...
  var generate = function (rdata) {
      return function (fmsg) {
          return new Generate(Pha_Effects_Random.wrapGen(rdata)(fmsg));
      };
  };
  var cards = [ Ace.value, Two.value, Three.value, Four.value, Five.value, Six.value, Seven.value, Eight.value, Nine.value, Ten.value, Jack.value, Queen.value, King.value ];
  var update = function (model) {
      return function (v) {
          if (v instanceof RollDice) {
              return new Data_Tuple.Tuple(model, [ generate(Pha_Effects_Random.randomInt(6))(DiceRolled.create) ]);
          };
          if (v instanceof DiceRolled) {
              return Pha.purely({
                  dice: v.value0,
                  card: model.card,
                  puzzle: model.puzzle
          ...
          if (v instanceof DrawCard) {
              return new Data_Tuple.Tuple(model, [ generate(Pha_Effects_Random.sample(cards))(CardDrawn.create) ]);
          };
          if (v instanceof CardDrawn && v.value0 instanceof Data_Maybe.Just) {
              return Pha.purely({
          ...
          if (v instanceof CardDrawn && v.value0 instanceof Data_Maybe.Nothing) {
              return Pha.purely(model);
          };
          if (v instanceof ShufflePuzzle) {
              return new Data_Tuple.Tuple(model, [ generate(Pha_Effects_Random.shuffle(model.puzzle))(Shuffled.create) ]);
          };
          if (v instanceof Shuffled) {
              return Pha.purely({
                  puzzle: v.value0,
                  card: model.card,
                  dice: model.dice
          ...
          throw new Error("Failed pattern match at Example.Random (line 41, column 16 - line 48, column 43): " + [ v.constructor.name ]);
      };
  };
  var main = Pha_App.attachTo("root")(Pha_App.app({
      init: Pha.purely(imodel),
      view: view,
      update: update,
  ...
  exports["DiceRolled"] = DiceRolled;
  exports["DrawCard"] = DrawCard;
  exports["CardDrawn"] = CardDrawn;
