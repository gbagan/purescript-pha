...
(function($PS) {
  ...
  var viewCard = function (v) {
      ...
      throw new Error("Failed pattern match at Example.Random (line 54, column 1 - line 54, column 25): " + [ v.constructor.name ]);
  };
  var view = function (v) {
      return {
  ...
  var update = function (v) {
      ...
      if (v instanceof DrawCard) {
          return Control_Bind.bind(Run.bindRun)(Pha_Effects_Random.sample([ Ace.value, Two.value, Three.value, Four.value, Five.value, Six.value, Seven.value, Eight.value, Nine.value, Ten.value, Jack.value, Queen.value, King.value ]))(function (v1) {
              ...
              throw new Error("Failed pattern match at Example.Random (line 45, column 5 - line 47, column 28): " + [ v1.constructor.name ]);
          });
      };
      ...
      throw new Error("Failed pattern match at Example.Random (line 37, column 1 - line 37, column 33): " + [ v.constructor.name ]);
  };
  var state = {
      dice: 1,
  ...
  var main = Pha_App.attachTo("root")(Pha_App.addInterpret(Pha_Effects_Random.interpretRng)(Pha_App.app({
