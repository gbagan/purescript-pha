...
(function($PS) {
  ...
  var viewCard = function (v) {
      ...
      throw new Error("Failed pattern match at Example.Random (line 49, column 1 - line 49, column 25): " + [ v.constructor.name ]);
  };
  var view = function (v) {
      return {
  ...
  var update = function (v) {
      if (v instanceof RollDice) {
          return Pha_Effects_Random.randomly(function (st) {
              ...
              })(Data_Functor.mapFlipped(Control_Monad_Free.freeFunctor)(Pha_Random.randomInt(6))(function (v1) {
                  return v1 + 1 | 0;
              }));
          });
      };
      if (v instanceof DrawCard) {
          return Pha_Effects_Random.randomly(function (st) {
              return Data_Functor.mapFlipped(Control_Monad_Free.freeFunctor)(Pha_Random.sample(cards))(function (v1) {
                  ...
                  throw new Error("Failed pattern match at Example.Random (line 44, column 22 - line 46, column 21): " + [ v1.constructor.name ]);
              });
          });
      };
