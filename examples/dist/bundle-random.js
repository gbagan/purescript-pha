...
(function($PS) {
      ...
      return function (setS) {
          return function (update) {
              return function (interpreter) {
                  ...
                  var dispatch = function ($56) {
                      return runAction(update($56));
                  };
                  var dispatchEvent = function (ev) {
                      return function (handler) {
                          ...
                          return function __do() {
                              ...
                              throw new Error("Failed pattern match at Pha.App (line 45, column 13 - line 47, column 36): " + [ v.msg.constructor.name ]);
                          };
                      };
                  };
                  return {
  ...
  var app = function (v) {
      return function (getS) {
          return function (setS) {
              var v1 = getTools(getS)(setS)(v.update)(v.interpreter);
              var init2 = Control_Apply.applySecond(Effect.applyEffect)(setS(v.init.value0))(v1.runAction(v.init.value1));
              return {
                  view: v.view,
                  init: init2,
                  subscriptions: v.subscriptions,
                  dispatch: v1.dispatch,
                  dispatchEvent: v1.dispatchEvent
              };
          };
      };
  };
