...
(function($PS) {
  ...
  var viewCard = function (v) {
      ...
      throw new Error("Failed pattern match at Example.Random (line 50, column 1 - line 50, column 27): " + [ v.constructor.name ]);
  };
  var state = {
      dice: 1,
  ...
  var rollDice = Control_Bind.bind(Run.bindRun)(Data_Functor.mapFlipped(Run.functorRun)(Pha_Random.randomInt(6))(function (v) {
      return v + 1 | 0;
  }))(function (v) {
  ...
  var drawCard = Control_Bind.bind(Run.bindRun)(Pha_Random.randomPick([ Ace.value, Two.value, Three.value, Four.value, Five.value, Six.value, Seven.value, Eight.value, Nine.value, Ten.value, Jack.value, Queen.value, King.value ]))(function (v) {
      if (v instanceof Data_Maybe.Just) {
          return Pha_Action.setState(function (v1) {
              return {
                  card: v.value0,
