...
})(PS["Pha.App.Router"] = PS["Pha.App.Router"] || {});
(function(exports) {
  "use strict";
...
(function($PS) {
  ...
  "use strict";
  $PS["Pha.App.Router"] = $PS["Pha.App.Router"] || {};
  var exports = $PS["Pha.App.Router"];
  var $foreign = $PS["Pha.App.Router"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Maybe = $PS["Data.Maybe"];
  ...
  var urlRequest = function (base) {
      return function (url) {
          var $20 = base.protocol === url.protocol && (base.host === url.host && base.port === url.port);
          if ($20) {
      ...
      return function (v1) {
          ...
          var hrefHandler = function (baseUrl) {
              return function (href) {
                  ...
                  throw new Error("Failed pattern match at Pha.App.Router (line 83, column 9 - line 86, column 65): " + [ v3.constructor.name ]);
              };
          };
...
(function($PS) {
  ...
  var functorNav = new Data_Functor.Functor(function (f) {
      return function (m) {
          ...
          throw new Error("Failed pattern match at Pha.Effects.Nav (line 11, column 1 - line 11, column 41): " + [ m.constructor.name ]);
      };
  });
  var emptyTitle = "";
  var interpretNav = function (v) {
      if (v instanceof GoTo) {
          return function __do() {
              Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.history))(Web_HTML_History.pushState($foreign.emptyObj)(emptyTitle)(v.value0))();
              $foreign.triggerPopState();
              return v.value1();
          };
      };
      if (v instanceof RedirectTo) {
          return function __do() {
              Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.history))(Web_HTML_History.replaceState($foreign.emptyObj)(emptyTitle)(v.value0))();
              $foreign.triggerPopState();
              return v.value1();
          };
      };
      ...
      throw new Error("Failed pattern match at Pha.Effects.Nav (line 32, column 1 - line 32, column 47): " + [ v.constructor.name ]);
  };
...
(function($PS) {
  ...
  var Pha_App_Router = $PS["Pha.App.Router"];
  ...
  var extractNumber = (function () {
      var $15 = Data_Maybe.fromMaybe(0);
      var $16 = Control_Bind.composeKleisli(Data_Maybe.bindMaybe)(Data_String_CodeUnits.stripPrefix("/page"))(Data_Int.fromString);
      return function ($17) {
          return $15($16($17));
      };
  })();
  var update = function (v) {
      if (v instanceof OnUrlChange) {
          return Pha_Update.purely(Data_Function["const"](v.value0));
      };
      if (v instanceof OnUrlRequest && v.value0 instanceof Pha_App_Router.Internal) {
          return Pha_Effects_Nav.goTo(v.value0.value0.href);
      };
      if (v instanceof OnUrlRequest && v.value0 instanceof Pha_App_Router.External) {
      ...
      if (v instanceof NextPage) {
          return Control_Bind.bind(Run.bindRun)(Pha_Update.getState)(function (v1) {
              return Pha_Effects_Nav.goTo("/page" + Data_Show.show(Data_Show.showInt)(extractNumber(v1.pathname) + 1 | 0));
          });
      };
      throw new Error("Failed pattern match at Example.Routing (line 28, column 1 - line 28, column 33): " + [ v.constructor.name ]);
  };
  var view = function (v) {
      return {
          title: "Routing example",
          body: Pha_Elements.div([  ])([ Pha_Elements.h1([  ])([ Pha.text("Page: " + v.href) ]), Pha_Elements.a([ Pha_Attributes.href("/page" + Data_Show.show(Data_Show.showInt)(extractNumber(v.pathname) - 1 | 0)) ])([ Pha.text("Previous page") ]), Pha_Elements.button([ Pha_Events.onclick(NextPage.value) ])([ Pha.text("Next page") ]) ])
      };
  };
  var main = Pha_App.attachTo("root")(Pha_App_Router.appWithRouter({
      init: function (v) {
          return new Data_Tuple.Tuple(v, Pha_Effects_Nav.redirectTo("/page0"));
      },
      view: view,
      update: update,
